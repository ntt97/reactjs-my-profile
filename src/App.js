        ...
        <div className={'viewContact'}>
          <div className={'viewWrapItemContact'}>
            <div className={'btnItemContact'}>
              ...
              <a href={'mailto:tranquangduy7994@gmail.com'} target="_blank" rel="noopener noreferrer"
                ...
                <span className={'textItemContact'}>nthanhtodev97@gmail.com</span>
              </a>
            </div>
          </div>
          ...
          <div className={'viewWrapItemContact'}>
            <div className={'btnItemContact'}>
              ...
              <a href={'skype:live:bae347cea73dcf75?chat'} target="_blank" rel="noopener noreferrer"
                 style={{'text-decoration': 'none'}}>
      ...
      <div className={'viewBody'}>
        ...
        <div className={'viewWrapItemBody'}>
          ...
          <div className={'viewWrapContentItemBody'}>
                        <span
                          className={'textContentItemBody1'}>{`Front-End developer with ${years} years ${months} months experience. I work with React Native, React js`}</span>
        ...
        <div className={'viewWrapItemBody'}>
          ...
          <div className={'viewWrapContentItemBody'}>
            ...
            <span className={'textContentItemBody'}>Fresher Software Engineer at EXE Corp</span>
        ...
        <div className={'viewWrapItemBody'}>
          ...
          <div className={'viewWrapContentItemBody'}>
            ...
            <span className={'textContentItemBody'}>App Shop Shoes</span>
              <span className={'textContentItemBody1'} href={'https://moga-app.web.app'}
               >React Native, Redux, Firebase, Nodejs , MongoDb</span>
            <div style={{height: '10px'}}/>
            <span className={'textContentItemBody'}>Web Food Binh Dinh</span>
              <span className={'textContentItemBody1'} href={'https://moga-app.web.app'}
               >JavaSpring MVC, SQL server</span>
            <div style={{height: '10px'}}/>
        ...
        <div className={'viewWrapItemBody'}>
          ...
          <div className={'viewWrapContentItemBody'}>
            ...
            <a className={'textContentItemBody1'} href={'https://github.com/ntt97'}
               target="_blank" rel="noopener noreferrer">https://github.com/ntt97</a>
        ...
        <div className={'viewWrapItemBody'}>
          ...
          <div className={'viewWrapContentItemBody'}>
            ...
            <span className={'textContentItemBody1'}>Firebase - intermediate</span>
            <span className={'textContentItemBody1'}>Backend - intermediate</span>
            <span className={'textContentItemBody1'}>Git - good</span>
            <span className={'textContentItemBody1'}>English - intermediate</span>
            <div style={{height: '10px'}}/>
        ...
        <div className={'viewWrapItemBody'}>
          ...
          <div className={'viewWrapContentItemBody'}>
            ...
            <div className={'viewWrapChildContent'}>
              <span className={'textContentItemBody1'}>&#9679; Vas Parent Portal (product, contribution rate 80%) - The app to connect teacher with parent (React Native, Firebase,Redux Saga , Typescript, notification...)</span>
              <span className={'textContentItemBody1'}>&#9679; Vas Teacher (product, contribution rate 100%) - The app to connect teacher with parent (React Native, Firebase,Redux Saga , Typescript, notification...)</span>
        ...
        <div className={'viewWrapItemBody'}>
          ...
          <div className={'viewWrapContentItemBody'}>
            <span className={'textContentItemBody'}>Posts and Telecommunications Institute of Technology (PTIT)</span>
